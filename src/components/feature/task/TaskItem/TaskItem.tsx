...
import type { BaseTask, TextTask, EngAudioTask, AnyTask } from "../types/task";
import GenericTableRenderer from "../lib/GenericTableRenderer";
...
import { TextWithImages } from "../lib/physic/TextWithImage";
import { TaskItemExplanation } from "../utils/TaskItemExplanation";
import { ParseMath } from "../lib/math/parse-math";
import ParseEngAudio from "../lib/eng/ParseEngAudio";
...
export function TaskItem({ task, isCorrect, setIsCorrect, slug, taskIndex }: TaskItemProps) {
  ...
  console.log(task.tableSpec, "tableSpec");
